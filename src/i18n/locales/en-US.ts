  ...
  system: {
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        failedNotice: {
          title: "{count} tasks have stopped retrying",
          description: "Select a red count to view the cause. Fix model, storage, or network issues before running a task again.",
        },
        failedTasks: {
