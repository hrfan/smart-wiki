  ...
  system: {
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        failedNotice: {
          title: "Задач без дальнейших повторов: {count}",
          description: "Нажмите красное число, чтобы увидеть причину. Перед новым запуском исправьте проблемы модели, хранилища или сети.",
        },
        failedTasks: {
