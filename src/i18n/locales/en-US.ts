...
\
  ...
  integrations: {
    ...
    api: {
      ...
      createApiKeyDialogDesc: 'Set the access role and available knowledge bases.',
      ...
      apiKeyAccessRoleHint: "Matches tenant member roles; requests are authorized by the selected role.",
      accessRoleViewer: "Viewer",
      accessRoleContributor: "Contributor",
      ...
      accessRoleAdminDesc: "Manage tenant-level settings and integrations; cannot create, rotate, or delete API keys.",
