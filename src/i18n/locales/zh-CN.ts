export default {
  ...
  uploadConfirm: {
    ...
    continueAdd: '继续添加',
    destinationLabel: '上传到',
    destinationRoot: '知识库顶层',
    destinationRootTip: '文件将上传到知识库顶层，不放入任何文件夹',
    destinationTip: '文件将上传到文件夹「{folder}」',
    destinationToRoot: '改为上传到顶层',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      title: '目录',
      rootRow: '全部文档',
      rootRowTip: '知识库顶层，所有文件夹都在它下面',
      rootRowDirect: '未归类文档',
      rootRowDirectTip: '直接上传、不在任何文件夹里的文档',
      scopeToggle: '切换列表范围',
      scopeSubtree: '含子目录',
      scopeDirect: '仅本层',
      scopeSubtreeTip: '列出所选目录及其子目录里的全部文档',
      scopeDirectTip: '只列出所选目录本层的文档；选中顶层即为未归类文档',
      collapse: '收起目录',
      expand: '展开目录',
