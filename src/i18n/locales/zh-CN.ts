export default {
  ...
  integrations: {
    ...
    api: {
      ...
      createApiKeyDialogDesc: "设置访问角色和可用知识库范围。",
      ...
      apiKeyAccessRoleHint: "与空间成员角色一致，请求时按所选角色鉴权。",
      accessRoleViewer: "访客",
      accessRoleContributor: "编辑",
      accessRoleAdmin: "管理员",
      accessRoleViewerDesc: "查询、检索和对话，不修改知识库内容。",
      accessRoleContributorDesc: "创建、更新或删除知识库内容，受知识库范围限制。",
      accessRoleAdminDesc: "管理租户级配置与集成设置；不能创建、轮换或删除 API 密钥。",
