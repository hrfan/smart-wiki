export default {
  ...
  integrations: {
    ...
    api: {
      ...
      createApiKeyDialogDesc: "접근 역할과 사용 가능한 지식베이스 범위를 설정하세요.",
      ...
      apiKeyAccessRoleHint: "워크스페이스 멤버 역할과 동일하며, 요청 시 선택한 역할로 인증됩니다.",
      accessRoleViewer: "뷰어",
      accessRoleContributor: "편집",
      accessRoleAdmin: "관리자",
      accessRoleViewerDesc: "조회, 검색 및 대화만 가능하며 지식베이스 내용은 수정하지 않습니다.",
      accessRoleContributorDesc: "선택한 범위 내에서 지식베이스 콘텐츠를 생성, 수정 또는 삭제합니다.",
      accessRoleAdminDesc: "테넌트 수준 설정 및 통합을 관리합니다. API Key 생성, 교체 또는 삭제는 불가합니다.",
