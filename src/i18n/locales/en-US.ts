export default {
  ...
  knowledgeBase: {
    ...
    moveToFolder: {
      ...
      title: 'Move {count} documents',
      hint: 'Pick a destination. Folders are derived from document paths, so this only changes grouping — nothing is re-parsed.',
      confirm: 'Move',
      newFolder: 'New sub-folder',
      newFolderPlaceholder: 'New folder name',
      newFolderPreview: 'Will create and move to "{path}"',
      newFolderUnderRoot: 'Enter a folder name',
