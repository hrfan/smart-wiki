...
/example\.(net|org)/`,
  ...
  integrations: {
    ...
    api: {
      ...
      createApiKeyDialogDesc: 'Укажите роль доступа и доступные базы знаний.',
      ...
      apiKeyAccessRoleHint: 'Соответствует роли участника workspace; запросы авторизуются по выбранной роли.',
      accessRoleViewer: 'Наблюдатель',
      accessRoleContributor: 'Редактор',
      ...
      accessRoleAdminDesc: 'Управление настройками арендатора и интеграциями; нельзя создавать, ротировать или удалять API keys.',
