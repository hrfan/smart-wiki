export default {
  ...
  knowledgeEditor: {
    activity: {
      ...
      allOutcomes: '모든 결과', refresh: '새로고침', retry: '다시 시도', empty: '아직 활동 기록이 없습니다',
      ...
      systemActor: '시스템', knowledgeBase: '지식 베이스', countSummary: '{label} · {count}개 항목',
      ...
      detailFields: { task_id: '작업 ID', trigger: '트리거', processing_status: '처리 상태', source_kb_id: '소스 지식 베이스 ID', target_kb_id: '대상 지식 베이스 ID', sync_log_id: '동기화 로그 ID', mode: '모드', attempt: '처리 시도', count: '항목 수', total: '전체', processed: '처리됨', failed: '실패', failure_stage: '실패 단계' },
      detailValues: { user: '사용자 시작', manual: '수동', schedule: '예약', system: '시스템', pending: '대기 중', completed: '완료', partial: '일부 완료', canceled: '취소됨', failed: '실패', enqueue: '작업 제출', reuse_vectors: '벡터 재사용', reparse: '재분석' },
      actions: {
