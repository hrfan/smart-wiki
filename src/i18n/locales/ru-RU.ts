export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      ...
      scopeSubtreeTip: 'Вложенные папки включены — нажмите, чтобы показать только этот уровень',
      scopeDirectTip: 'Показан только этот уровень — нажмите, чтобы включить вложенные папки',
