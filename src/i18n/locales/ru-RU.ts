export default {
  ...
  uploadConfirm: {
    ...
    destinationLabel: 'Загрузить в',
    destinationRoot: 'Верхний уровень базы знаний',
    destinationRootTip: 'Файлы попадут на верхний уровень базы знаний, вне папок',
    destinationTip: 'Файлы попадут в папку «{folder}»',
    destinationToRoot: 'Загрузить на верхний уровень',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      title: 'Папки',
      rootRow: 'Все документы',
      rootRowTip: 'Верхний уровень базы знаний — все папки находятся внутри него',
      rootRowDirect: 'Документы вне папок',
      rootRowDirectTip: 'Документы, загруженные по отдельности и не находящиеся ни в одной папке',
      scopeToggle: 'Изменить область списка',
      scopeSubtree: 'С вложенными',
      scopeDirect: 'Этот уровень',
      scopeSubtreeTip: 'Показать все документы выбранной папки и её вложенных папок',
      scopeDirectTip: 'Показать только документы самой выбранной папки; на верхнем уровне это документы вне папок',
