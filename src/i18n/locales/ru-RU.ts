  ...
  system: {
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        description: "Актуальная глубина фоновых очередей задач (парсинг/обогащение) и настройки параллелизма воркеров. Только для просмотра; автообновление каждые 5 сек.",
        refresh: "Обновить",
        ...
        weight: "Вес {value}",
        footnote: "Параллелизм — это настроенный предел пула воркеров (вступает в силу после перезапуска); «Активные» — число задач, обрабатываемых сейчас.",
        ...
        summary: {
          ...
          pending: "В очереди",
          retry: "Повтор",
          concurrency: "Параллелизм Parse / Wiki",
        },
        columns: {
          queue: "Очередь",
          active: "Активные",
        ...
        queueDescriptions: {
          default: "Парсинг документов и общая постобработка",
          low: "Сводки, синхронизация источников, пакетный повторный разбор и удаление",
