export default {
  ...
  knowledgeEditor: {
    ...
    activity: {
      ...
      detailFields: { task_id: "任务 ID", trigger: "触发方式", processing_status: "处理状态", source_kb_id: "来源知识库 ID", target_kb_id: "目标知识库 ID", sync_log_id: "同步记录 ID", mode: "执行模式", attempt: "处理批次", count: "项目数", total: "总数", processed: "已处理", failed: "失败数", failure_stage: "失败阶段" },
      detailValues: { user: "用户发起", manual: "手动触发", schedule: "定时调度", system: "系统触发", pending: "待处理", completed: "已完成", partial: "部分完成", canceled: "已取消", failed: "失败", enqueue: "任务提交", reuse_vectors: "复用向量", reparse: "重新解析" },
      actions: {
