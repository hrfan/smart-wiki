...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      enableLabel: 'Включить Wiki',
      enableTip: 'При включении загрузка документов автоматически создаст связанные Wiki-страницы',
      autoIngestLabel: 'Автоматический Ingest',
      autoIngestTip: 'При загрузке новых документов автоматически создаются/обновляются Wiki-страницы',
