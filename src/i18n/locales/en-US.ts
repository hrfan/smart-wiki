export default {
  ...
  knowledgeBase: {
    ...
    folderTree: {
      title: 'Folders',
      rootRow: 'All documents',
      rootRowTip: 'The top level of the knowledge base; every folder sits below it',
      rootRowDirect: 'Unfiled documents',
      rootRowDirectTip: 'Documents uploaded on their own, not inside any folder',
      scopeToggle: 'Change list scope',
      scopeSubtree: 'With sub-folders',
      scopeDirect: 'This level',
      scopeSubtreeTip: 'List every document in the selected folder and its sub-folders',
      scopeDirectTip: 'List only the selected folder\'s own documents; on the top level these are the unfiled ones',
  ...
  uploadConfirm: {
    ...
    destinationLabel: 'Upload to',
    destinationRoot: 'Knowledge base top level',
    destinationRootTip: 'Files go to the top level of the knowledge base, not into any folder',
    destinationTip: 'Files go into the folder "{folder}"',
    destinationToRoot: 'Upload to the top level instead',
