export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillSourceTokenLabel: 'Private SkillHub token',
      skillSourceTokenPlaceholder: 'Optional',
      skillSourceTokenHint: 'Only needed for a self-hosted or private SkillHub. Used for this download only, not stored.',
