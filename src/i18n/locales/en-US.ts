export default {
  ...
  knowledgeEditor: {
    activity: {
      ...
      allOutcomes: 'All outcomes', refresh: 'Refresh', retry: 'Retry', empty: 'No activity yet',
      ...
      systemActor: 'System', knowledgeBase: 'Knowledge base', countSummary: '{label} · {count} items',
      ...
      detailFields: { task_id: 'Task ID', trigger: 'Trigger', processing_status: 'Processing status', source_kb_id: 'Source knowledge base ID', target_kb_id: 'Target knowledge base ID', sync_log_id: 'Sync log ID', mode: 'Mode', attempt: 'Processing attempt', count: 'Item count', total: 'Total', processed: 'Processed', failed: 'Failed', failure_stage: 'Failure stage' },
      detailValues: { user: 'User initiated', manual: 'Manual', schedule: 'Scheduled', system: 'System', pending: 'Pending', completed: 'Completed', partial: 'Partially completed', canceled: 'Canceled', failed: 'Failed', enqueue: 'Task submission', reuse_vectors: 'Reuse vectors', reparse: 'Reparse' },
      actions: {
