export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      skillSourcePlaceholder: 'Вставьте URL или {\'@\'}owner/slug',
      skillSourceTokenLabel: 'Токен закрытого SkillHub',
      skillSourceTokenPlaceholder: 'Необязательно',
      skillSourceTokenHint: 'Нужен только для собственного или закрытого SkillHub. Используется только для этой загрузки и не сохраняется.',
