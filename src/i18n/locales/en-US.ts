export default {
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      enableLabel: 'Enable Wiki',
      enableTip: 'When enabled, uploading documents will auto-generate interlinked wiki knowledge pages',
      autoIngestLabel: 'Auto Ingest',
      autoIngestTip: 'When enabled, uploading new documents automatically triggers Wiki page generation/update',
      synthesisModelLabel: 'Synthesis Model',
