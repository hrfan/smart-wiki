export default {
  ...
  uploadConfirm: {
    ...
    destinationRoot: '지식 베이스 최상위',
    destinationRootTip: '파일이 폴더가 아닌 지식 베이스 최상위에 업로드됩니다',
    destinationTip: '파일이 「{folder}」 폴더에 업로드됩니다',
    destinationToRoot: '최상위에 업로드하도록 변경',
  ...
  knowledgeBase: {
    ...
    folderTree: {
      title: '폴더',
      rootRow: '전체 문서',
      rootRowTip: '지식 베이스의 최상위이며 모든 폴더가 그 아래에 있습니다',
      rootRowDirect: '미분류 문서',
      rootRowDirectTip: '단독으로 업로드되어 어떤 폴더에도 속하지 않은 문서',
      scopeToggle: '목록 범위 변경',
      scopeSubtree: '하위 포함',
      scopeDirect: '현재 단계',
      scopeSubtreeTip: '선택한 폴더와 하위 폴더의 모든 문서를 표시합니다',
      scopeDirectTip: '선택한 폴더 자체의 문서만 표시합니다. 최상위에서는 미분류 문서입니다',
      collapse: '폴더 접기',
      expand: '폴더 펼치기',
