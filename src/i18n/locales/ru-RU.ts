export default {
  ...
  knowledgeBase: {
    ...
    moveToFolder: {
      ...
      title: 'Переместить документов: {count}',
      hint: 'Выберите папку. Папки выводятся из путей документов, поэтому меняется только группировка — повторная обработка не выполняется.',
      confirm: 'Переместить',
      newFolder: 'Новая вложенная папка',
      newFolderPlaceholder: 'Название новой папки',
      newFolderPreview: 'Будет создана папка «{path}»',
      newFolderUnderRoot: 'Введите название папки',
