export default {
  ...
  knowledgeEditor: {
    ...
    wiki: {
      ...
      enableLabel: "Wiki 활성화",
      enableTip: "활성화하면 문서 업로드 시 자동으로 상호 연결된 Wiki 지식 페이지가 생성됩니다",
      autoIngestLabel: "자동 Ingest",
      autoIngestTip: "활성화하면 새 문서 업로드 시 자동으로 Wiki 페이지가 생성/업데이트됩니다",
